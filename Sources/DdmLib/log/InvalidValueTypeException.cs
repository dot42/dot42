...
{
    /// <summary>
	/// Exception thrown when associating an <seealso cref="EventContainer.EventValueType"/> with an incompatible
	/// <seealso cref="EventValueDescription.ValueTypes"/>.
	/// </summary>
	public sealed class InvalidValueTypeException : Exception
	{
		...
		public InvalidValueTypeException() : base("Invalid Type")
		{
		}
		...
		/// <seealso cref= java.lang.Exception </seealso>
		public InvalidValueTypeException(Exception cause) : base(cause.Message, cause)
		{
		}
		...
		/// and indicates that the cause is nonexistent or unknown.) </param>
		/// <seealso cref= java.lang.Exception </seealso>
		public InvalidValueTypeException(string message, Exception cause) : base(message, cause)
		{
		}
	}
