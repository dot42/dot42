...
{
    public sealed class BlackBerryDeviceItem : DeviceItem
    {
        private readonly BlackBerryDevice device;

        /// <summary>
        /// Default ctor
        /// </summary>
        internal BlackBerryDeviceItem(BlackBerryDevice device)
        {
            this.device = device;
            ReloadIcon();
            SetName(device.Name);
