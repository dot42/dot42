...
namespace MonoTests.System.Collections
{
    ...
    public class ArrayListTest
    {
		...
		[Test]
		[Ignore("TrimToSize not implemented")]
	...
	[Category ("NotDotNet")] // MS bug
        ...
        public void TestToArray()
        {
            var _ushort = (ushort)42;
            var _ushortTypeRT = _ushort.GetType();
            var _ushortTypeCT = typeof(ushort);

            //To debug easier, the following two lines are included
            var _ushortTypeRTFullName = _ushortTypeRT.FullName;
            var _ushortTypeCTFullName = _ushortTypeCT.FullName;
            ...
            var array = (ushort[])list.ToArray(typeof(ushort));
