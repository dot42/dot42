...
namespace Cases.Case651
{
    public class Test : TestCase
    {
        ...
        {
            //var lblPesoValor = FindViewById<TextView>(R.Id.lblPesoValor);
            lblPesoValorText = x.Progress.ToString();

            //// Dosis 
            double value = 0;
            double peso = (double)x.Progress;
            //var CodigoTextBox0 = FindViewById<TextView>(R.Id.CodigoTextBox0);
            //value = ObternerValor(peso, 0.15D, 1); 
            value = peso * 0.15D / 1;
            CodigoTextBox0Text = String.Format("{0:0.00}", value) + " " + "ml";
            //var CodigoTextBox1 = FindViewById<TextView>(R.Id.CodigoTextBox1);
            //value = ObternerValor(peso, 0.33D, 1); 
            value = peso * 0.33D / 1;
            CodigoTextBox1Text = String.Format("{0:0.00}", value) + " " + "ml";
            //var CodigoTextBox2 = FindViewById<TextView>(R.Id.CodigoTextBox2);
            //value = ObternerValor(peso, 0.33D, 2); 
            value = peso * 0.33D / 1;
            CodigoTextBox2Text = String.Format("{0:0.00}", value) + " " + "ml";
            //var CodigoTextBox3 = FindViewById<TextView>(R.Id.CodigoTextBox3);
            //value = ObternerValor(peso, 0.33D, 2); 
            value = peso * 0.33D / 2;
            CodigoTextBox3Text = String.Format("{0:0.00}", value) + " " + "ml";
            //var CodigoTextBox4 = FindViewById<TextView>(R.Id.CodigoTextBox4);
            //value = ObternerValor(peso, 0.33D, 2); 
            value = peso * 0.33D / 2;
