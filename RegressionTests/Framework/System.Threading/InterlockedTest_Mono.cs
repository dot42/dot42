...
namespace MonoTests.System.Threading
{
	...
	public class InterlockedTest
	{
        ...
        [Test]
        public void CompareExchange_GenericField()
        {
            var a = new GenericClass<object>();
            var b = new GenericClass<object> { value = new object() };

            Assert.IsNull(Interlocked.CompareExchange<object>(ref a.value, a.value, a.value), "null,null,null");
            
            Assert.IsNull(Interlocked.CompareExchange<object>(ref a.value, a.value, b.value), "null,non-null,non-null");
            Assert.IsNull(Interlocked.CompareExchange<object>(ref a.value, b.value, a.value), "null,non-null,null");
            Assert.AreSame(b.value, Interlocked.CompareExchange<object>(ref a.value, b.value, b.value), "null,null,non-null");

            Assert.AreSame(b.value, Interlocked.CompareExchange<object>(ref b.value, a.value, a.value), "non-null,null,null");
            Assert.AreSame(b.value, Interlocked.CompareExchange<object>(ref b.value, a.value, b.value), "non-null,null,non-null");
            Assert.AreSame(b.value, Interlocked.CompareExchange<object>(ref b.value, b.value, a.value), "non-null,non-null,null");
            Assert.AreSame(b.value, Interlocked.CompareExchange<object>(ref b.value, b.value, b.value), "non-null,non-null,non-null");
        }

        [Test]
        public void Exchange_GenericField()
        {
            var a = new GenericClass<object>();
            var b = new GenericClass<object> { value = new object() };

            Assert.IsNull(Interlocked.Exchange<object>(ref a.value, a.value), "null,null");
            Assert.IsNull(Interlocked.Exchange<object>(ref a.value, b.value), "null,non-null");
            Assert.AreSame(b.value, Interlocked.Exchange<object>(ref b.value, a.value), "non-null,null");
            Assert.AreSame(b.value, Interlocked.Exchange<object>(ref b.value, b.value), "non-null,non-null");
        }
