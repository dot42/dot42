...
#pragma warning restore 1718
	...
	[Test] //Adjusted for Java!
	public void TestGetHashCode ()
	{
		Boolean t=true, f=false;
        Assert.AreEqual(1231, t.GetHashCode(), "GetHashCode True failed");
        Assert.AreEqual(1237, f.GetHashCode(), "GetHashCode False failed");
	}
	...
	[Test]
	//[ExpectedException (typeof (FormatException))] in Java invalid stuff is false.
	public void ParseInvalid ()
	{
	    Assert.AreEqual(false, Boolean.Parse("not-t-or-f"));
	}
	...
	{
		Boolean t=true,f=false;
		Assert.AreEqual(Boolean.TrueString.ToLower(), t.ToString(), "ToString True Failed");
		Assert.AreEqual(Boolean.FalseString.ToLower(), f.ToString(), "ToString False Failed");
	}
}
