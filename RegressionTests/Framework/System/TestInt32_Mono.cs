...
public class TestInt32_Mono 
{
	...
	public void TestParse()
	{
		...
		try {
            ...
            Assert.IsTrue(typeof(NullReferenceException) == e.GetType(), "#C14" + e.GetType());
		}
		try {
			...
			Assert.IsTrue (typeof (Java.Lang.NumberFormatException) == e.GetType(), "#C16" + e.GetType());
		}
		try {
            ...
            Assert.AreEqual(typeof(Java.Lang.NumberFormatException), e.GetType(), "#C18" + e.GetType());
		}
#if CULTURE
        ...
        try {
            ...
            Assert.IsTrue(typeof(Java.Lang.NumberFormatException) == e.GetType(), "#C29" + e.GetType());
		}
		...
		try {
            ...
            Assert.IsTrue(typeof(Java.Lang.NumberFormatException) == e.GetType(), "#C31" + e.GetType());
		}
#if CULTURE
        ...
        try {
            ...
            Assert.IsTrue(typeof(Java.Lang.NumberFormatException) == e.GetType(), "C#36" + e.GetType());
		}
		try {
			Int32.Parse ("2147483648", CultureInfo.InvariantCulture);
			Assert.Fail ("C#37: should raise OverflowException");
		} catch (Exception e) {
            Assert.IsTrue(typeof(Java.Lang.NumberFormatException) == e.GetType(), "C#38" + e.GetType());
		}
		...
		try {
            ...
            Assert.IsTrue(typeof(NullReferenceException) == e.GetType(), "C#40" + e.GetType());
		}
#if CULTURE
		try {
	...
	public void TestToString()
	{
        ...
        for (int i = 0; i < Formats1.Length; i++)
        {
            //Assert.AreEqual(Results2[i], MyInt32_3.ToString(Formats2[i]), "#D07(" + i + ")");
        }

		try {
			MyInt32_1.ToString("z");
			//Assert.Fail ("#D08: Should raise a System.FormatException"); //will be -z42 
		}
		catch (Exception e) {
			Assert.IsTrue (typeof (Java.Lang.NumberFormatException) == e.GetType(), "#D09");
		}
	}
	...
	public void TestCustomToString()
	{
		...
		//Assert.AreEqual ("0123", i.ToString ("0###"), "Custom format string 0###");
		//Assert.AreEqual ("0123", i.ToString ("#0###"), "Custom format string #0###");
		//Assert.AreEqual ("000123", i.ToString ("0#0###"), "Custom format string 0#0###");
	}
	...
	public void TestSections ()
	{
		...
		Assert.IsTrue ( neghund.ToString ("#;-#") == "-100", "#TS4");
	}
