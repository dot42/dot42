...
namespace MonoTests.System
{
	...
	public class DoubleTest
	{
		...
		private readonly static Double d_nan = Double.NaN;
        private readonly static Double d_pinf = Double.PositiveInfinity;
        private readonly static Double d_ninf = Double.NegativeInfinity;
		...
		public void CompareTo ()
		{
			...
			Assert.IsTrue (d_pos.CompareTo ((object)null) > 0, "#C3");
		...
		public void IsNan ()
		{
            ...
            Assert.IsFalse(Double.IsNaN(Double.MaxValue), "#4");
            Assert.IsFalse(Double.IsNaN(Double.MinValue), "#5");
		}
		...
		public void Parse ()
		{
            ...
            {
                Assert.AreEqual(typeof(NullReferenceException), ex.GetType(), "#D2");
			...
			try {
                ...
                Assert.AreEqual(typeof(Java.Lang.NumberFormatException), ex.GetType(), "#E2");
            ...
            string sep = "."; //US
#endif
			double ovf_plus = Double.Parse ("1" + sep + "79769313486232e308");
            Assert.IsTrue(Double.IsPositiveInfinity(ovf_plus), "#F1");

            double ovf_min = Double.Parse ("-1" + sep + "79769313486232e308");
            Assert.IsTrue(Double.IsNegativeInfinity(ovf_min), "#G1");
			...
			for (i = 0; i < string_values_fail.Length; ++i) {
                ...
                {
                    Assert.AreEqual(typeof(Java.Lang.NumberFormatException), ex.GetType(), "#H2");
		...
		public void Parse_Whitespace ()
		{
            ...
            {
                Assert.AreEqual(typeof(Java.Lang.NumberFormatException), ex.GetType(), "#2");
