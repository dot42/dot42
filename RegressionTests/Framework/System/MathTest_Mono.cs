	...
	public class MathTest
	{
		...
		*/
...
#if NOT_IMPLEMENTED // I have not idea why this gives wrong results.
        [Test] 
		public void TestIEEERemainder () 
		{
            ...
            //var epsilon = Math.Ulp(b);
            var epsilon = double_epsilon;


            Assert.IsTrue((Math.Abs(a - b) <= epsilon), a.ToString("R") + " != " + b.ToString ("R"));
		...
		public void TestLog2 ()
		{
			...
			Assert.IsTrue ((Math.Abs (a - b) <= 1e-14), a + " != " + b
				+ " because diff is " + Math.Abs (a - b).ToString("R"));
		...
		public void TestPow ()
		{
			...
			try {
                ...
                Assert.IsTrue((Math.Abs(a - b) <= epsilon), a.ToString("G99") + " != " + b.ToString("G99"));
				iTest++;
        ...
        [Test]
        public void TestUlongMax2()
        {
            ulong a = 0xA000000000000000UL;
            ulong b = 0xB000000000000000UL;
		...
		public void TestDoubleRound3 ()
		{
			...
			Assert.AreEqual (1d, Math.Round (0.5, 0, MidpointRounding.AwayFromZero));
		}
